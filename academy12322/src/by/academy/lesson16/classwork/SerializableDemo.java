...
// Написать метод который циклически просматривает содержимое 
// заданного каталога (например, папка с вашим проектом) и ищет все java классы(*.java), 
// после чего записывает название всех классов в файл.
// Используем рекурсию.