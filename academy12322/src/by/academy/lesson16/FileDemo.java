...
public class FileDemo {
	public static void main(String[] args) throws IOException {
		// src/io/1/2/3/4/5/6/7/8/9 - относительный путь
		// С://program file - абсолютный
...
//		}
		File test = new File(
				"C:/Users/dmitrysc/git/academy11122/academy11122/src/io/1/2/3/4/5/6/7/8/9/Hello_World.txt");

		if (!test.exists()) {
			test.mkdirs();
		}
		System.out.println(test.isAbsolute());
		System.out.println(dirs.isAbsolute());
